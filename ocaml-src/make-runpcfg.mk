...
#MLGSLINC := -I $(PREFIX)/lib/ocaml/site-lib/gsl
...
#MLGSLINC := /usr/local/lib/ocaml/gsl
...
#runpcfg
runpcfg: pcfg/runpcfg.ml id.cmx globals.cmx utils.cmx  pcfg/pcfg.cmx  tree.cmx \
	sexp.cmx cyk.cmx
