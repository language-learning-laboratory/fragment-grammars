...
in let options = [
  ...
  in let _ = Globals.setDebugFile !debugfile in
    ...
    in let forms = ["age";"an";"ary";"dom";"ee";"en";"er";"ery";"ess";"ette";"fold";"ful";"hood";"ish";"ism";"ist";"ive";"less";"ling";"ly";"ment";"ness";"or";"ous";"ry";"ship";"ster";"th";"wise"]
